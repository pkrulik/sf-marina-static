 ...
 */
$config['successMessage'] = 'Thanks for the note. We’ll be in touch!';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = array('pkrulik@theviaagency.com' => 'Scentovation.com');
 ...
 */
$config['subject'] = 'Message from Scentovation.com';
 ...
 * Validators: Required
 */
$name = new Quform_Element('name', 'Sent from:');
$name->addFilter('trim');
$name->addValidator('required');
$form->addElement($name);

$company = new Quform_Element('company', 'Sent from:');
$company->addFilter('trim');
$company->addValidator('required');
$form->addElement($company);

$address = new Quform_Element('address', 'Sent from:');
$address->addFilter('trim');
$address->addValidator('required');
$form->addElement($address);

$phone = new Quform_Element('phone', 'Sent from:');
$phone->addFilter('trim');
$phone->addValidator('required');
$form->addElement($phone);

$email = new Quform_Element('email', 'Sent from:');
 ...
 * Validators: Required
 */
$textarea = new Quform_Element('textarea', 'Message:');
$textarea->addValidator('required');
$textarea->addFilter('trim');
$form->addElement($textarea);

/** END REQUEST FORM ELEMENT CONFIGURATION **/
