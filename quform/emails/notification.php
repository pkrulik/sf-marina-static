...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td valign="top" style="padding: 25px;"><table width="600" cellpadding="0" cellspacing="0" border="0" style="font: 14px Helvetica, Arial, sans-serif;">
            <tr>
                <td valign="top" style="font-family: Helvetica, Arial, sans-serif; font-size: 11px; color: #222; padding-bottom: 10px; text-transform: uppercase; font-weight:bold;">Message submitted via Scentovation.com:</td>
            </tr>
            <tr>
                <td valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="0">
                    <?php foreach ($form->getElements() as $element) : ?>
                        <?php if (!$element->isHidden() && ($config['showEmptyFields'] || (!$config['showEmptyFields'] && !$element->isEmpty()))) : ?>
                            <tr>
                                <td valign="top" style="font-family: Helvetica, Arial, sans-serif; color: #222; font-size: 13px; line-height: 17px; width: 80px;"><?php echo Quform::escape($element->getLabel())?></td>
                                <td valign="top" style="font-family: Helvetica, Arial, sans-serif; color: #222; font-size: 13px; line-height: 17px; width: 340px">
